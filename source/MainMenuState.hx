...
class MainMenuState extends MusicBeatState
{
	...
	public var motdURL:String = "http://bloodieysart.rf.gd/media/motd.txt"; 
	...
	public function setMOTDURL(MOTDURL:String)
	{
		motdURL = MOTDURL;
	}
	...
	override function create()
	{
		...
		var motdhttp = new haxe.Http(motdURL);
		var motdtext:String;
		...
		add(messageoftheday);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "vs Gnarpy v" + psychEngineVersion, 12);
